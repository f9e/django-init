django-init | [![Build Status](https://travis-ci.org/f9e/django-init.svg?branch=master)](https://travis-ci.org/f9e/django-init)
============
...
```
cookiecutter gh:f9e/django-init
```
...
Forked from a project built with ♥ at [Fueled](https://fueled.com)
